...
export default function Admin() {
  ...
  const handleEditImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      try {
        ...
        setEditingProduct((prev: any) => ({ ...prev, image: compressedBase64 }));
      } catch (error) {
  ...
  const handleUpdateProduct = (e: React.FormEvent) => {
    e.preventDefault();
    if (!editingProduct || !editingProduct.name || !editingProduct.price || !editingProduct.image) {
    ...
    updateProduct(editingProduct.id, {
      ...
      sizes: editingProduct.sizes.length > 0 ? editingProduct.sizes : ['One Size'],
    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-20">
      ...
      {editingProduct && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[85vh] overflow-y-auto shadow-2xl p-8 relative animate-scale-in text-left">
            {/* Close Button */}
            <button 
            ...
            <h2 className="text-2xl font-serif mb-6 text-slate-900">Edit Product</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="mt-3 flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="hidden"
                      />
                      <p className="text-xs text-slate-500 mt-2">Upload a high-quality JPEG/PNG image.</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditingProduct({ ...editingProduct, category: e.target.value as 'men' | 'women' })}
                    className="w-full mt-1.5 border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-slate-900"
                  >
                    <option value="men">Men</option>
                    <option value="women">Women</option>
                  </select>
                ...
                {/* In Stock Toggle */}
                <div className="md:col-span-2 flex items-center justify-between p-4 bg-stone-50 rounded-xl">
                  <div>
                    <p className="text-sm font-medium text-slate-900">In Stock Status</p>
                    <p className="text-xs text-slate-500">Enable or disable availability of this item.</p>
                  </div>
                  <input
                    type="checkbox"
