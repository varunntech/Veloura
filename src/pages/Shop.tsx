...
export default function Shop() {
  ...
  const { products, getByCategory, searchProducts, deleteProduct } = useProducts();
  const { user } = useAuth();
                      ...
                      <div className="relative aspect-[3/4] overflow-hidden bg-stone-100 mb-4">
                        ...
                        {user?.isAdmin && (
                          <button
                            ...
                            className="absolute bottom-3 right-3 p-2.5 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg transition-transform hover:scale-110 z-10"
                    ...
                    >
                      ...
                      <div className="flex-1 py-2">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right flex flex-col justify-between items-end min-h-[6.5rem]">
                            <div>
                            ...
                            {user?.isAdmin && (
                              <Button
                                ...
                                className="mt-auto bg-red-600 hover:bg-red-700 text-white font-medium"
                              >
