...
export default function ProductDetail() {
  ...
  const { getProduct, addReview, deleteProduct } = useProducts();
      ...
      <div className="container-premium">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="lg:py-4">
            ...
            {user?.isAdmin && (
              <div className="bg-red-50 border border-red-200 rounded-xl p-5 mb-8 flex items-center justify-between animate-fade-in">
                <div>
                  <h4 className="font-serif text-lg font-medium text-red-900 mb-1">Admin Controls</h4>
                  <p className="text-xs text-red-600">Delete this product permanently from the website.</p>
                </div>
                <Button 
                  variant="destructive"
                  onClick={() => {
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-medium shadow-md transition-transform hover:scale-102"
                >
